...
const Create = (props: any) => {
  ...
  const { values, errors, touched, handleChange, handleBlur, handleSubmit, setFieldValue } =
    useFormik({
      ...
      onSubmit: (values, action) => {
        ...
        const { guardian_info, ...sendValues } = valuewithSibling;
  ...
  const handleTransferCertificate = (e: any) => {
    const file = e.target.files[0];
  ...
  const handleCharacterCertificate = (e: any) => {
    const file = e.target.files[0];
  ...
  const handleBirthCertificate = (e: any) => {
    const file = e.target.files[0];
  ...
  const handleHealthRecord = (e: any) => {
    const file = e.target.files[0];
    ...
    if (file) {
      ...
      if (file.type === "image/png" || file.type === "image/jpeg" || file.type === "image/heic") {
        ...
        setFieldValue("health_record", file.name);
      } else {
        message.error("Please select a valid PNG, JPEG, or HEIC image.");
        e.target.value = "";
        return;
  ...
  const handleClassRecord = (e: any) => {
    ...
    if (file) {
      ...
      if (file.type === "image/png" || file.type === "image/jpeg" || file.type === "image/heic") {
        ...
        setFieldValue("class_record", file.name);
      } else {
        message.error("Please select a valid PNG, JPEG, or HEIC image.");
        e.target.value = "";
        return;
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={4}>
                      <MDInput
                        ...
                        success={values.admission_date && !errors.admission_date}
                    ...
                    <Grid item xs={12} sm={4}>
                      <MDInput
                        ...
                        success={values.admission_number && !errors.admission_number}
                    ...
                    <Grid item xs={12} sm={4}>
                      <MDInput
                        ...
                        success={values.fee_code && !errors.fee_code}
                    ...
                    <Grid item xs={6} sm={4}>
                      <MDInput
                        ...
                        success={values.birth_place && !errors.birth_place}
                      />
                    </Grid>
                    <Grid item xs={6} sm={4}>
                      <MDInput
                    ...
                    <Grid item xs={6} sm={4}>
                      <MDInput
                        ...
                        success={values.aadhaar_number && !errors.aadhaar_number}
                      />
                    </Grid>
                    <Grid item xs={6} sm={4}>
                      <MDInput
                        ...
                        success={values.mother_tongue && !errors.mother_tongue}
                    ...
                    <Grid item xs={6} sm={4}>
                      <MDInput
                        ...
                        success={values.religion && !errors.religion}
                      />
                    </Grid>
                    <Grid item xs={6} sm={4}>
                      <Autocomplete
                        ...
                        renderInput={(params: any) => (
                          <MDInput
                            ...
                            success={values.caste && !errors.caste}
                      ...
                      <Autocomplete
                        ...
                        renderInput={(params: any) => (
                          <MDInput
                            ...
                            success={values.caste_category && !errors.caste_category}
                          />
                        )}
                      />
                    </Grid>
                      ...
                      <Autocomplete
                        ...
                        renderInput={(params: any) => (
                          <MDInput
                            ...
                            success={values.house_details && !errors.house_details}
                    ...
                    <Grid item xs={6} sm={4}>
                      <MDInput
                        ...
                        success={values.pen_number && !errors.pen_number}
                      />
                    </Grid>
                    <Grid item xs={6} sm={4}>
                      <Autocomplete
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={4}>
                      <MDInput
                        ...
                        onBlur={handleBlur}
                        error={
                          touched.sibling_admission_number &&
                          Boolean(errors.sibling_admission_number)
                        }
                        helperText={
                          touched.sibling_admission_number && errors.sibling_admission_number
                        }
                        success={
                          values.sibling_admission_number && !errors.sibling_admission_number
                        }
                      />
                    </Grid>
                  </Grid>
                  ...
                  <Grid container spacing={2}>
                    ...
                    {values.guardian_info?.map((clone, index) => (
                      <>
                        ...
                        <Grid item xs={12} sm={6} key={index + "removeguardianfield"}>
                        ...
                        <Grid item xs={12} sm={4} key={index + "first_name"}>
                          <MDInput
                            ...
                            error={
                              ...
                              Boolean(
                                (errors.guardian_info as FormikErrors<Guardian>[])?.[index]
                                  ?.first_name
                              )
                            }
                            success={
            ...
            <Grid item xs={12} sm={4} key={index + "designation"}>
              <MDInput
                ...
                error={
                  ...
                  Boolean((errors.guardian_info as FormikErrors<Guardian>[])?.[index]?.designation)
                }
                success={
              ...
              />
                        ...
                        <Grid item xs={12} mb={2} mt={1} sm={4} key={index + "notification"}>
                          <FormControl>
                            <RadioGroup
                        ...
                        <Grid item xs={12} mb={2} mt={1} sm={4} key={index + "subscription"}>
                          <FormControl>
                            <RadioGroup
                              aria-labelledby="demo-radio-buttons-group-label"
                              row
