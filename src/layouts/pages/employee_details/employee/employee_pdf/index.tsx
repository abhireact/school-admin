        ...
        <Card>
          <MDBox p={4}>
            <Grid container spacing={1}>
              ...
              <Grid item xs={12} sm={6} sx={{ display: "flex", justifyContent: "flex-end" }}></Grid>
        ...
        <Card>
          <MDBox p={4}>
            <Grid container spacing={1}>
              ...
              <Grid item xs={12} sm={3}></Grid> {/* Add an empty Grid item to make it 4 columns */}
              <Grid item xs={12} sm={3}>
                <MDTypography variant="body2" fontWeight="bold">
