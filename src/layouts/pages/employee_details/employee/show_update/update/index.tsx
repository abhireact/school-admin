  ...
  const { values, handleChange, handleBlur, handleSubmit, setFieldValue, touched, errors } =
    useFormik({
      initialValues: {
        ...
        employee_notification: employeeInfo.employee_notification || false,
        employee_subscription: employeeInfo.employee_subscription || false,
        employee_email_notificaton: employeeInfo.employee_email_notificaton || false,
        employee_email_subscription: employeeInfo.employee_email_subscription || false,
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={6} sm={4}>
                  <MDInput
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    error={touched.total_month_experience && Boolean(errors.total_month_experience)}
                  ...
                  <Autocomplete
                    ...
                    renderInput={(params: any) => (
                      <MDInput
                        ...
                        variant="standard"
                        onBlur={handleBlur}
                        error={touched.employee_department && Boolean(errors.employee_department)}
          ...
          <Grid item sm={12} id="4">
            <MDBox p={4}>
              <Grid container spacing={2} id="4">
                ...
                <Grid item xs={12} sm={12}>
                  <MDTypography color="secondary" variant="body2" fontWeight="bold" fontSize="14px">
                    CURRENT ADDRESS
                  </MDTypography>
                </Grid>
                <Grid item xs={12} sm={4}>
                ...
                <Grid item xs={12} sm={12}>
                  <FormControl>
                    ...
                    >
                      <FormControlLabel
                        control={<Checkbox checked={checkAddress} onChange={handleCheckAddress} />}
                        label={
                          <MDTypography variant="button" fontWeight="bold" color="secondary">
