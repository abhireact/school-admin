...
export default function IntraPortalStatusReport() {
  ...
  const { values, errors, touched, handleBlur, handleChange, handleSubmit } = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      axios
        .post("http://10.0.20.200:8000/internal_portal/reports", values, {
          headers: {
  ...
  const SmsTableData = {
    ...
    rows: smsData.map((data, index) => ({
      ...
      receiver: data.action[0].user_type,
